"""
This is based on Andrej Karpathy's makemore implementation, 
here for the purpose of creating names
that sound like players for the Seattle Seahawks.
"""
...
if __name__ == '__main__':
    ...
    # system/input/output
    parser.add_argument('--input-file', '-i', type=str, default='seahawks.txt', help="input file with things one per line")
